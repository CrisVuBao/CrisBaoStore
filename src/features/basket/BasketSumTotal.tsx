...
export default function BasketSumTotal({ subtotal }: Props) {
    ...
    if (subtotal === undefined)
        subtotal = basket?.items.reduce((sum, item) => sum + (item.quantity * item.price_KM), 0) ?? 0;
    const deliveryFee = subtotal > 30000 ? 0 : 10000;
            ...
            <TableContainer component={Paper} variant={'outlined'}>
                <Table>
                    <TableBody>
                        ...
                        <TableRow>
                            <TableCell>
                                <span style={{ fontStyle: 'italic' }}>*Orders over 30.000VNĐ qualify for free delivery</span>
                            </TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
