...
namespace CrisBaoStoreAPI.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserDto>> Login (LoginDto loginDto)
        {
            ...
            var userBasket = await RetrieveBasket(loginDto.UserName); // giỏ hàng của người dùng đã đăng nhập
            var anonBasket = await RetrieveBasket(Request.Cookies["buyerId"]); // lấy giỏ hàng của người dùng không đăng nhập (buyerId)
